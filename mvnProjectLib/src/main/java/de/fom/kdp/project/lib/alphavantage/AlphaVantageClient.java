...
public class AlphaVantageClient {
	...
	public AlphaVantageClient(String apiKey) {
	   ...
	   /**
     * Retrieves historical stock data for the given symbol from the Alpha Vantage API.
     * <p>
     ...
     * @return a {@code Map} where the key is the date and the value is the closing price
     * @throws Exception if an error occurs while making the API request or parsing the response
     */
     ...
     * @param data a {@code Map} containing the date as the key and the closing price as the value
     ...
     * <p>
     * This method reads the API key from the configuration file, retrieves historical data 
     * for the Microsoft stock ("MSFT"), and writes the data to a CSV file.
     * </p>
     * 
